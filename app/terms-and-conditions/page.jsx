...
export const metadata = {
  title: "Terms and Conditions | Multi Tool",
  description:
    "Read the terms and conditions of using Multi Tool's online tools collection.",
  keywords: "terms and conditions, multi tool, legal",
  openGraph: {
    type: "website",
    title: "Terms and Conditions | Multi Tool",
    description:
  ...
  jsonLd: {
    ...
    description:
      "Read the terms and conditions of using Multi Tool's online tools collection.",
    url: "http://localhost:3000/terms-and-conditions",
    mainEntityOfPage: "http://localhost:3000/terms-and-conditions",
  },
};
  ...
  return (
    <section className="mt-24 bg-white p-6 rounded  container mx-auto px-4 sm:px-10 lg:px-28">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Reproducing, duplicating, or copying material from Multi Tools</li>
      ...
      <p className="mb-4">
        ...
        contract. Multi Tools, including its officers, directors, and employees,
      ...
      <p className="mb-4">
        You hereby indemnify to the fullest extent Multi Tools from and against
      ...
      <p className="mb-4">
        These terms constitute the entire agreement between Multi Tools and you
