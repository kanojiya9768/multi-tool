...
export default function QRReader() {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto mt-8 p-6">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">QR Code Reader</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
          ...
          >
            ...
            {isDragActive ? (
              ...
              <p className="text-gray-500">
                Drag & drop an image here, or <Button variant="link" className="p-0 text-blue-500">choose a file</Button>
              </p>
            )}
          </motion.div>
        ...
        {imageSrc && (
          <div className="flex flex-col items-center space-y-4">
            ...
            />
            <Button onClick={scanQRCode} variant="secondary" disabled={isScanning}>
